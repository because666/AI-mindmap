        ...
        <div className="p-6 space-y-5 max-h-[60vh] overflow-y-auto">
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-dark-700 border border-dark-600 rounded-xl text-white focus:border-primary-500 focus:outline-none transition-colors"
              placeholder="输入节点标题"
            />
          </div>
              ...
              <div className="max-h-32 overflow-y-auto bg-dark-700 border border-dark-600 rounded-xl">
                {availableParents.length === 0 ? (
                  ...
                  availableParents.map((parent) => (
                    <label
                      key={parent.id}
                      className="flex items-center gap-3 px-4 py-2 hover:bg-dark-600 cursor-pointer transition-colors border-b border-dark-600 last:border-b-0"
                    >
                      <input
                        type="checkbox"
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 px-4 py-2 bg-dark-700 border border-dark-600 rounded-xl text-white focus:border-primary-500 focus:outline-none transition-colors text-sm"
                placeholder="添加标签"
              />
              <button
                onClick={handleAddTag}
                className="px-4 py-2 bg-dark-600 text-white rounded-xl hover:bg-dark-500 transition-colors"
              >
